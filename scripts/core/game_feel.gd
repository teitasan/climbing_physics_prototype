...
const TRAVERSE_STEP_M := 0.25
const TRAVERSE_HAND_S := 0.14
const TRAVERSE_PELVIS_S := 0.12
const TRAVERSE_FOOT_S := 0.12
const MANTLE_DURATION := 0.58
const GRAB_DURATION := 0.20
const GRAB_IK_MAX := 0.80
const HANG_IK_MAX := 0.98
